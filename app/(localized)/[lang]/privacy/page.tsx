...
export default async function Page({params}:{params:Promise<{lang:string}>}) { const {lang}=await params; return <LegalPage locale={isLocale(lang)?lang:"en"} type="privacy"/>; }
