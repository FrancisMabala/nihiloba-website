import { acceptCommercePriceChanges, CommerceApiError } from "../../../../services/shida/commerce-client";
...
export async function POST(request: Request) {
  ...
  try { return privateJson({ cart: await acceptCommercePriceChanges(token) }); }
