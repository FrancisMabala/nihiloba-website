  ...
  return (
    <footer className="site-footer">
      <div className="container footer-grid">
        ...
        <div className="footer-column"><p className="footer-label">{t.legal}</p><Link href={localizedPath(locale,"/privacy")}>{t.privacy}</Link><Link href={localizedPath(locale,"/terms")}>{t.terms}</Link></div>
      </div>
