...
const faqCopy = {
  en: {
    ...
    sections: [
      ...
      ["contact", "How can I contact NIHILOBA?", `Support questions may be sent to ${CONTACT_EMAILS.support} or through the NIHILOBA contact page.`],
    ],
  },
  fr: {
    ...
    sections: [
      ...
      ["contact", "Comment contacter NIHILOBA ?", `Les questions d’assistance peuvent être envoyées à ${CONTACT_EMAILS.support} ou au moyen de la page de contact de NIHILOBA.`],
    ],
  },
} as const;
...
const acceptableCopy = {
  en: {
    ...
    sections: [
      ...
      {id:"contact",title:"5. Contact",paragraphs:[`Questions or reports concerning acceptable use may be sent to ${CONTACT_EMAILS.legal}.`],items:undefined},
    ],
  },
  fr: {
    ...
    sections: [
      ...
      {id:"contact",title:"5. Contact",paragraphs:[`Les questions ou signalements concernant l’utilisation acceptable peuvent être envoyés à ${CONTACT_EMAILS.legal}.`],items:undefined},
    ],
  },
} as const;
