...
const content: Record<Locale, {
  ...
  en: {
    ...
    sections: [
      ...
      { id: "contact", title: "Contact", paragraphs: ["Questions regarding security may be sent to:", "Email", CONTACT_EMAILS.security] },
  ...
  fr: {
    ...
    sections: [
      ...
      { id: "contact", title: "Contact", paragraphs: ["Pour toute question relative à la sécurité, vous pouvez nous écrire à :", "E-mail", CONTACT_EMAILS.security] },
