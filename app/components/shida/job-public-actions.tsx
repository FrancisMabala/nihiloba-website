...
export function ExternalJobAction({ locale, jobReference, action, label }: { locale:Locale; jobReference:string; action:PublicJobExternalAction; label?:string }) {
